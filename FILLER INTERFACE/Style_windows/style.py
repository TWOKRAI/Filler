...
class Style():
    def __init__(self):
        self.icon_path_orig = r"FILLER INTERFACE\Style_windows\icons"
        self.icon_path = r"FILLER INTERFACE\Style_windows\icons_black"
    ...
    def style(self):
        with open(r'FILLER INTERFACE\Style_windows\style_green.css', 'r') as f:
            custom_style = f.read()
